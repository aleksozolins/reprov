...
# Stow dotfiles
cd ~/.dotfiles/
stow --no-folding alacritty arch dunst emacs flameshot fontconfig gnupg mac_linux mc mpd ncmpcpp nvim pam-gnupg picom sxhkd tmux w3m youtube-dl zathura mutt abook
